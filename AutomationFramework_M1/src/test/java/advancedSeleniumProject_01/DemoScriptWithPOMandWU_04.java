...
public class DemoScriptWithPOMandWU_04  {
	...
	public static void main(String[] args) throws IOException {
		...
		// to read data from property file
				...
				//Select energy in the dropdown
				WebElement DROPDOWNTEXTFIELD = cop.getIndustryDropdownTextField();
				
				wutil.toHandledropdown(DROPDOWNTEXTFIELD,"Energy");
				WebElement TYPEDROPDOWNTEXTFIELD = cop.getTypeDropDowntextField();
				
				wutil.toHandledropdown(TYPEDROPDOWNTEXTFIELD, "Customer");
